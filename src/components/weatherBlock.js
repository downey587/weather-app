...
function WeatherDayBlock( { temp, feelsLike, wind, clouds, pressure, desc, date } ) {
    ...
    let style = `w-auto h-auto py-5 ${ bgColor } rounded-xl`;
    ...
    return (
        <div className={ style }>
            ...
            <h1 className="px-4 text-slate-400"> { dateCont } </h1>
        </div>
    );
}
        ...
        <div className="w-full h-auto mt-6">
            <div>
                { 
                    ...
                    <div>
                        <div>
                            <h1 className="text-lg ml-1 font-medium mb-3"> Current Weather </h1>
                       ...
                       <div className="mt-12">
                            <h1 className="text-lg ml-1 font-medium mb-3"> Next 9 hours forecast </h1>
                            
                            <div className="grid grid-flow-col grid-cols-1 grid-rows-3 gap-6">
                        ...
                        <div className="mt-12">
                            <h1 className="text-lg ml-1 font-medium mb-3"> Next 3 days forecast </h1>
                        ...
                        <div className="mt-12">
                            <h1 className="text-lg ml-1 font-medium mb-3"> Next 5 days forecast </h1>
